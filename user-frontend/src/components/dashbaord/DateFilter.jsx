...
const DateFilter = () => {
  ...
  return (
    <div className="flex items-center gap-2">
      <label htmlFor="date-filter" className="text-sm font-medium text-slate-600">
        Period
      </label>
      <select
        id="date-filter"
        className="border border-slate-300 px-3 py-2 rounded-lg shadow-sm bg-white text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 transition"
        value={filter}
