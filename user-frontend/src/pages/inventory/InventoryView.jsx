...
const InventoryView = () => {
  ...
  if (loading) return <p className="p-6 dark:text-slate-300">Loading...</p>;
  if (!item) return <p className="p-6 dark:text-slate-300">No data</p>;
  ...
  return (
 <div className="w-full min-h-screen p-6 bg-white dark:bg-slate-950">
...
<div className="mb-4">
  <Link
    to="/inventory/list"
    className="flex items-center text-gray-600 hover:text-gray-800 font-medium transition dark:text-slate-400 dark:hover:text-slate-200"
  >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-1 flex justify-center items-start">
          <img
            ...
            alt={item.name}
            className="rounded-lg border shadow-sm max-h-64 object-cover dark:border-slate-800"
          />
        </div>

        {/* Details */}
        <div className="md:col-span-2 space-y-3 text-gray-700 dark:text-slate-300 text-sm">
