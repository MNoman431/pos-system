...
const Unauthorized = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-slate-50 dark:bg-slate-950 px-4 text-center">
      <div className="rounded-2xl border border-slate-200 bg-white p-10 shadow-sm max-w-md w-full dark:border-slate-800 dark:bg-slate-900">
        ...
        <Link
          ...
          className="mt-6 inline-block rounded-lg bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-400 shadow-sm transition"
        >
